...
const Modal : React.FC<ModalProps> = ({
  ...
  return (
   <>
        <div className='justify-center items-center flex overflow-hidden overflow-y-auto fixed inset-0 
            z-50 outline-none focus:outline-none bg-neutral-800/70'>
                <div className='relative w-full md:w-4/6 lg:w-3/6 xl:2/5 my-6 mx-auto h-full 
                    lg:h-auto md:h-auto'>
                        {/* Content */}
                        <div 
